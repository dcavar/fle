/**
 * \file XLEFeaturesParserTest.cpp
 *
 * \brief Provide a parser for XLE FEATURES files based on XLEFeaturesParser.cpp
 *
 * The purpose of this parser is to test the implementation of the BNF
 * grammar for XLE FEATURES and the resulting parser class generated by BNFC.
 *
