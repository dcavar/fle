/**
 * \file XLEConfigParserTest.cpp
 *
 * \brief Provide a parser for XLE CONFIG files based on XLEConfigParser.cpp
 *
 * The purpose of this parser is to test the implementation of the BNF
 * grammar for XLE CONFIG and the resulting parser class generated by BNFC.
 *
