/**
 * \file XLEMorphologyTextParserTest.cpp
 *
 * \brief Provide a parser for XLE MORPHOLOGYTEXT files based on XLEMorphologyTextParserTest.cpp
 *
 * The purpose of this parser is to test the implementation of the BNF
 * grammar for XLE MORPHOLOGYTEXT and the resulting parser class generated by BNFC.
 *
...
int main(int argc, char ** argv) {
    ...
    if (argc > 1) {
        ...
        XLEMorphologyTextParser *p = new XLEMorphologyTextParser();
