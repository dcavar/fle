/**
 * \file XLERulesParserTest.cpp
 *
 * \brief Provide a parser for XLE RULES files based on XLERulesParserTest.cpp
 *
 * The purpose of this parser is to test the implementation of the BNF
 * grammar for XLE RULES and the resulting parser class generated by BNFC.
 *
