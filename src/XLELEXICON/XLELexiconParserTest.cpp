/**
 * \file XLELexiconParserTest.cpp
 *
 * \brief Provide a parser for XLE LEXICON files based on XLELexiconParser.cpp
 *
 * The purpose of this parser is to test the implementation of the BNF
 * grammar for XLE LEXICON and the resulting parser class generated by BNFC.
 *
...
int main(int argc, char **argv) {
    ...
    if (argc > 1) {
        ...
        XLELexiconParser *p = new XLELexiconParser();
