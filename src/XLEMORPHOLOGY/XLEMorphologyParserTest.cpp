/**
 * \file XLEMorphologyParserTest.cpp
 *
 * \brief Provide a parser for XLE MORPHOLOGY files based on XLEMorphologyParser.cpp
 *
 * The purpose of this parser is to test the implementation of the BNF
 * grammar for XLE MORPHOLOGY and the resulting parser class generated by BNFC.
 *
...
int main(int argc, char ** argv) {
    ...
    if (argc > 1) {
        ...
        XLEMorphologyParser *p = new XLEMorphologyParser();
